...
namespace WebStore.Tests.Controllers
{
    ...
    public class CartControllerTests
    {
        ...
        public async Task CheckOut_Calls_Service_and_Return_Redirect()
        {
            ...
            var order_service_mock = new Mock<IOrderService>();
            order_service_mock
                .Setup(x => x.CreateOrder(It.IsAny<string>(), It.IsAny<CreateOrderModel>()))
                .ReturnsAsync(new OrderDTO(expected_order_id, "OrderName", "Phone", "Address", DateTime.Now, new List<OrderItemDTO>()));
