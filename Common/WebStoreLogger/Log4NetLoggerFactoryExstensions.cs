...
{
    public static class Log4NetLoggerFactoryExstensions
    {
        ...
        private static string CheckFilePath(string File)
        {
            ...
            var assembly = Assembly.GetExecutingAssembly() ?? throw new InvalidOperationException("Не удалось определить сборку, содержащую точку входа в приложение.");
